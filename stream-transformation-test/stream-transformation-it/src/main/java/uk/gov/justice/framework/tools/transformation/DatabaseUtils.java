...
public class DatabaseUtils {
    ...
    public void insertEventLogData(final String eventName, final UUID streamId, final long sequenceId, final ZonedDateTime createdAt) throws InvalidSequenceIdException {
